<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"F:\www\hiv/app/admin\view\message\answer_message.html";i:1519959458;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<div class="layui-form" style="margin-top: 10px;">
		<div class="layui-form-item layui-form-text">
		    ...
		    <div class="layui-input-inline" style="width: 70%;">
				<textarea placeholder="请输入回复内容" name="answer_content" lay-verify="required" class="layui-textarea" style="height:150px;"></textarea>
		    </div>
		</div>
		<input type="hidden" value="<?php echo input('param.id'); ?>" name="id">
		<div class="layui-form-item">
		    <div class="layui-input-block">
		    	<button class="layui-btn" lay-submit="" lay-filter="sub">提交回复</button>
		    </div>
		</div>
	</div>
	...
	<script type="text/javascript">
		layui.use('form', function () {
            ...
            form.on('submit(sub)', function (data) {
                ...
                $.post("<?php echo url('answerMessage'); ?>",data.field,function(res){
                    layer.close(loading);
                    if(res.status > 0){
