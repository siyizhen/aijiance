<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"F:\www\hiv/app/home\view\mobile\index.html";i:1520408150;s:50:"F:\www\hiv/app/home\view\mobile\footer_tabbar.html";i:1520408552;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div id="mainBox">
	<div class="hd_nav">
        <a><i class="icon icon-laptop"></i><b>小黄盒</b></a>
    	<a><i class="icon icon-library"></i><b>防艾险</b></a>
        <a><i class="icon icon-keyboard"></i><b>保密协议</b></a>
        <a><i class="icon icon-users"></i><b>关于我们</b></a>
        <a><i class="icon icon-headphones"></i><b>联系我们</b></a>
        <a><i class="icon icon-question"></i><b>常见问题</b></a>
    </div>
...
<div class="weui-tabbar">
    <a href="<?php echo url('home/index/index'); ?>" class="weui-tabbar__item weui-bar__item_on <?php if($controller == index): ?>tabon<?php endif; ?>">
        <span class="icon_box">
            <i class="weui-tabbar__icon tab_icon fa fa-home"></i>
        </span>
        <p class="weui-tabbar__label">主页</p>
    </a>
    <a href="<?php echo url('home/baoxian/index'); ?>" class="weui-tabbar__item weui-bar__item_on">
        <span class="icon_box">
