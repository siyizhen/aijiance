<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"E:\www\hiv/app/user\view\pc\my_questionnaire.html";i:1520253748;s:44:"E:\www\hiv/app/user\view\pc\user_header.html";i:1520253373;s:42:"E:\www\hiv/app/user\view\pc\user_left.html";i:1520253373;s:44:"E:\www\hiv/app/user\view\pc\user_footer.html";i:1520009084;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="title">
	{{#  if(d.origin_is_read == 2){ }}
		<a href="<?php echo url('myQuestion'); ?>?questionnaire_id={{d.questionnaire_id}}" class="layui-table-link">{{d.title}}</a> <span class="layui-badge-dot"></span>
	{{#  } else { }}
		<a href="<?php echo url('myQuestion'); ?>?questionnaire_id={{d.questionnaire_id}}" class="layui-table-link">{{d.title}}</a>
	{{#  } }}
</script>
...
<script>
	layui.use('table', function(){
		...
		table.render({
			id:'list',
			elem: '#list'
			,url: "<?php echo url('user/index/myQuestionnaire'); ?>"
			,page: true
			,cols: [[
