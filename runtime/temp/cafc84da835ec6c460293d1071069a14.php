<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"F:\www\hiv/app/user\view\pc\my_questionnaire.html";i:1520233462;s:44:"F:\www\hiv/app/user\view\pc\user_header.html";i:1520234370;s:42:"F:\www\hiv/app/user\view\pc\user_left.html";i:1520234224;s:44:"F:\www\hiv/app/user\view\pc\user_footer.html";i:1519955022;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="title">
	{{#  if(d.origin_is_read == 2){ }}
		<a href="<?php echo url('myQuestion'); ?>?questionnaire_id={{d.id}}" class="layui-table-link">{{d.title}}</a> <span class="layui-badge-dot"></span>
	{{#  } else { }}
		<a href="<?php echo url('myQuestion'); ?>?questionnaire_id={{d.id}}" class="layui-table-link">{{d.title}}</a>
	{{#  } }}
</script>
