<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:52:"F:\www\hiv/app/admin\view\question\question_add.html";i:1517994900;s:42:"F:\www\hiv/app/admin\view\common\head.html";i:1519691410;s:42:"F:\www\hiv/app/admin\view\common\foot.html";i:1519691410;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
    	<div class="layui-form-item">
            ...
            <div class="layui-input-1">
                <input type="text" name="sort" placeholder="<?php echo lang('pleaseEnter'); ?>排序" class="layui-input" value="<?php echo $sort; ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="question" lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>问题" class="layui-input">
            </div>
        </div>
        ...
        <input id="questionnaire_id" name="questionnaire_id" type="hidden" value="<?php echo input('param.questionnaire_id'); ?>">

        <div class="layui-form-item">
            <div class="layui-input-block">
                <button type="button" class="layui-btn" lay-submit="" lay-filter="submit"><?php echo lang('submit'); ?></button>
                <a href="<?php echo url('question'); ?>?questionnaire_id=<?php echo input('param.questionnaire_id'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
            </div>
        </div>
    </form>
</div>
...
<script>
    ...
    layui.use(['form', 'layer','laydate'], function () {
        ...
        $("#show_box dl dd").click(function() {
        	...
        	if(types=='radio'){
                ...
                var str='<div class="option-item"><div class="options"><input type="textarea" class="layui-textarea layui-disabled" disabled="disabled"><img class="option-del" src="__STATIC__/admin/images/btn-del.png" title="删除该选项"></div></div>';
            }
    ...
    function addOptions(){
        ...
        $('.option-list .option-item').each(function(i){
            ...
            var text = (type!='radio' && type!='checkbox' && type!='textarea')? '':$this.find('input.input_length').val();
