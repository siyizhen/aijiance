<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"E:\www\hiv/app/user\view\pc\my_question.html";i:1520253373;s:44:"E:\www\hiv/app/user\view\pc\user_header.html";i:1520253373;s:42:"E:\www\hiv/app/user\view\pc\user_left.html";i:1520253373;s:44:"E:\www\hiv/app/user\view\pc\user_footer.html";i:1520009084;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="main fly-user-main layui-clear layui-anim">
    ...
    <div class="fly-panel fly-panel-user" style="margin-top: 70px;">
			...
			<table class="layui-table">
				...
				<thead>
					<tr>
						<th>编号</th>
						<th>标题</th>
						<th style="color: red;font-weight: bolder;">回答</th>
					</tr> 
				</thead>
				<tbody>
					...
					<tr>
						<td><?php echo $m['indexs']; ?></td>
						<td><?php echo $m['question']; ?></td>
						<td style="color: red;font-weight: bolder;"><?php echo $m['answer']; ?></td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
		...
		<div style="text-align: center;">
			<a href="<?php echo url('myQuestionnaire'); ?>" class="layui-btn layui-btn-primary">返回问卷列表</a>
		</div>
    </div>
