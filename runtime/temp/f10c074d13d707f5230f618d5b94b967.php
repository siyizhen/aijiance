<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"F:\www\hiv/app/user\view\mobile\login.html";i:1520494596;}*/ ?>
<!DOCTYPE html>
<html>
<head lang="en">
<meta charset="UTF-8">
...
<div class="cationBox">
    ...
    <input type="hidden" value="<?php echo input('param.preferUrl'); ?>" id="preferUrl"> 
    <input type="hidden" value="<?php echo input('param.sence'); ?>" id="sence">
...
<script type="text/javascript">
    /*获取验证码*/
        ...
        function login(){
            ...
            $.post("<?php echo url('login/index'); ?>?preferUrl="+$("#preferUrl").val()+"&sence="+$.trim($("#sence").val()),data,function(res){
